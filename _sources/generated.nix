...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  Moralerspace = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-hj/Oh8IdHcH+6/6cP+MHYhhYzzk6jFJQO9Eb11dugX4=";
    };
  };
  MoralerspaceHW = {
    pname = "MoralerspaceHW";
    version = "v1.1.0";
    src = fetchurl {
      url = "https://github.com/yuru7/moralerspace/releases/download/v1.1.0/MoralerspaceHW_v1.1.0.zip";
      sha256 = "sha256-fXvhgtE5MO9nEOwd5hrcW/l0C42XVM/VJgvKP0I5yPU=";
    };
  };
  MoralerspaceHWJPDOC = {
    pname = "MoralerspaceHWJPDOC";
    version = "v1.1.0";
    src = fetchurl {
      url = "https://github.com/yuru7/moralerspace/releases/download/v1.1.0/MoralerspaceHWJPDOC_v1.1.0.zip";
      sha256 = "sha256-iu6mYWgB9IYGSZRDWYFClwSMCBMjyEBvUwpYJuoSY6Y=";
    };
  };
  MoralerspaceHWNF = {
    pname = "MoralerspaceHWNF";
    version = "v1.1.0";
    src = fetchurl {
      url = "https://github.com/yuru7/moralerspace/releases/download/v1.1.0/MoralerspaceHWNF_v1.1.0.zip";
      sha256 = "sha256-tFGM7t51kxXL5F7SJJo4WV8COsbtQ+3yC1cOfYCQuqY=";
    };
  };
  MoralerspaceJPDOC = {
    pname = "MoralerspaceJPDOC";
    version = "v1.1.0";
    src = fetchurl {
      url = "https://github.com/yuru7/moralerspace/releases/download/v1.1.0/MoralerspaceJPDOC_v1.1.0.zip";
      sha256 = "sha256-RlgenD8vQdpGAWSanaz1TgVRsGo16+pWuHYMuTWN3g8=";
    };
  };
  MoralerspaceNF = {
    pname = "MoralerspaceNF";
    version = "v1.1.0";
    src = fetchurl {
