...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  zotero-better-bibtex = {
    ...
    version = "7.0.44";
    src = fetchurl {
      url = "https://github.com/retorquere/zotero-better-bibtex/releases/download/v7.0.44/zotero-better-bibtex-7.0.44.xpi";
      sha256 = "sha256-TAkpdm4+99FFB3FaGhqzrhoo1rhDl+nLnKXtkZdi4Po=";
    };
  ...
  zotero-pdf-translate = {
    ...
    version = "2.3.7";
    src = fetchurl {
      url = "https://github.com/windingwind/zotero-pdf-translate/releases/download/v2.3.7/translate-for-zotero.xpi";
      sha256 = "sha256-Q+JlZjwPpxjHY4efGPi/qtW37RcrXHz7tfyXATRL6sc=";
    };
