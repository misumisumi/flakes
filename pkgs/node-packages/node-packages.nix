...
let
  sources = {
    ...
    "@swc/core-1.7.5" = {
      ...
      version = "1.7.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.7.5.tgz";
        sha512 = "qKK0/Ta4qvxs/ok3XyYVPT7OBenwRn1sSINf1cKQTBHPqr7U/uB4k2GTl6JgEs8H4PiJrMTNWfMLTucIoVSfAg==";
      };
    };
    "@swc/counter-0.1.3" = {
