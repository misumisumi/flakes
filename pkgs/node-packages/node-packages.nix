...
let
  sources = {
    ...
    "@swc/core-1.4.11" = {
      ...
      version = "1.4.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.4.11.tgz";
        sha512 = "WKEakMZxkVwRdgMN4AMJ9K5nysY8g8npgQPczmjBeNK5In7QEAZAJwnyccrWwJZU0XjVeHn2uj+XbOKdDW17rg==";
      };
    };
    "@swc/counter-0.1.3" = {
