...
let
  sources = {
    ...
    "@nx/devkit-20.6.2" = {
      ...
      version = "20.6.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@nx/devkit/-/devkit-20.6.2.tgz";
    ...
    "@swc/core-1.11.11" = {
      ...
      version = "1.11.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.11.11.tgz";
        sha512 = "pCVY2Wn6dV/labNvssk9b3Owi4WOYsapcbWm90XkIj4xH/56Z6gzja9fsU+4MdPuEfC2Smw835nZHcdCFGyX6A==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "nx-20.6.2" = {
      ...
      version = "20.6.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/nx/-/nx-20.6.2.tgz";
        sha512 = "FvdDpBRgTdlTO0ixFjtZnMsp25MMBUzHcylVphekVY4vdFOnJ54f9Y64oncqcj70gyKX6Qn9g9+hEzV4bomYeQ==";
      };
    };
    "object-assign-3.0.0" = {
      name = "object-assign";
    ...
    "sql-formatter-15.5.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "H3XfFRpK8LybkU2mD2Vj3AF35YcfviwUuy3yl98Xp7DTneJJVB40L654DpHYIRctASNIQPoLo7+yCboOfkOpWA==";
      };
    };
    "ssri-10.0.6" = {
      name = "ssri";
