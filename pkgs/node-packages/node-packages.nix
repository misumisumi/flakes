...
let
  sources = {
    ...
    "oxc-resolver-11.6.2" = {
      ...
      version = "11.6.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/oxc-resolver/-/oxc-resolver-11.6.2.tgz";
        sha512 = "9lXwNQUzgPs5UgjKig5+EINESHYJCFsRQLzPyjWLc7sshl6ZXvXPiQfEGqUIs2fsd9SdV/jYmL7IuaK43cL0SA==";
      };
    };
    "p-finally-1.0.0" = {
      name = "p-finally";
...
in
{
  ...
  "@commitlint/config-lerna-scopes" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."napi-postinstall-0.3.3"
